...
CHEBYSHEV_DEGREE = 9 # Grad des Tschebyscheff-Polynoms. Ein höherer Grad -> genauere Approximation, erhöht aber auch Multiplikationstiefe, Rauschen und Berechnungszeit in CKKS
...
context = ts.context(
    ts.SCHEME_TYPE.CKKS,
    poly_modulus_degree=32768, # 16384 ->error  # Grad des Polynommoduls. Ein höherer Grad erhöht die Sicherheit und die Kapazität des Ciphertextes, verlangsamt aber die Berechnung.
    ...
    coeff_mod_bit_sizes=[60] + [40]*12 + [60] # Kette von Primzahlen-Moduln. 
)
